...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->foreignIdFor(Brand::class, 'brand_id')->nullable()->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignIdFor(Category::class, 'category_id')->nullable()->cascadeOnDelete()->cascadeOnUpdate();
            $table->softDeletes();
            $table->timestamps();
        });
    }
