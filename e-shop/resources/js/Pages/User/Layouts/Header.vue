        ...
        <div class="max-w-screen-xl mx-auto flex items-center justify-between p-4">
            ...
            <!-- <div class="flex-1 flex items-center justify-center">
                <ul class="flex space-x-8 rtl:space-x-reverse font-medium">
                    ...
                    <li>
                        <a href="#"
                            class="text-yellow-900 dark:text-white hover:text-blue-700 dark:hover:text-blue-500">Services</a>
                    </li>
                    <li>
                        <a href="#"
                            class="text-yellow-900 dark:text-white hover:text-blue-700 dark:hover:text-blue-500">Pricing</a>
                    </li>
                    <li>
                        <a href="#"
