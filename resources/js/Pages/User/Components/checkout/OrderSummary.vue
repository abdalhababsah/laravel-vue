<template>
    <div class="space-y-4 border border-gray-200 lg:w-[352px] w-full bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:w-full lg:max-w-xs xl:max-w-md">
        ...
        <div class="space-y-4">
            <div class="space-y-2">
                <dl class="flex items-center justify-between gap-4">
                    ...
                    <dd class="text-base font-medium text-gray-900">JOD {{ total }}</dd>
                </dl>
                <dl class="flex items-center justify-between gap-4">
                    <dt class="text-base font-normal text-gray-500">Delivery</dt>
                    <dd class="line-through text-base font-medium text-gray-900">JOD 2.00</dd>
                </dl>
                <dl class="flex items-center justify-between gap-4">
                    <dt class="text-base font-normal text-gray-500">Tax</dt>
                    <dd class="text-base font-medium text-gray-900">JOD 0.00</dd>
                </dl>
            </div>

            <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2">
                <dt class="text-base font-bold text-gray-900">Total</dt>
                <dd class="text-base font-bold text-gray-900">JOD {{ total }}</dd>
            </dl>
        </div>
        ...
        <button @click="handleCheckout" :disabled="!isFormValid || processing"
