                            ...
                            <div class="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                                    <div class="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]">
                                        <img src="https://hips.hearstapps.com/hmg-prod/images/zita-dhauteville-seen-wearing-a-beige-fendi-peekaboo-bag-a-news-photo-1680227150.jpg?crop=0.536xw:1.00xh;0.376xw,0&resize=980:*"
                                ...
                                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                                    <div
                                        ...
                                        <img src="https://cbu01.alicdn.com/img/ibank/O1CN01U75Omm1QDwPqJFbcS_!!2809961943-0-cib.jpg"
                                            alt="about image" class="object-cover object-center w-full h-full" />
                                    </div>

                                    <div
                                        class="relative z-10 mb-4 flex items-center justify-center overflow-hidden bg-[#b0956e] px-6 py-12 sm:mb-8 sm:h-[160px] sm:p-5 lg:mb-4 xl:mb-8">
                                        <div>
